...
func TestCircleHitbox(t *testing.T) {
	...
	hb := &circleHitbox{
		...
		orientation: 0,
		radius:      10,
		entity:      &entity.TestEntity{0, false, 0},
	}
...
func TestLocation(t *testing.T) {
	...
	ent := &entity.TestEntity{5, false, 0}
...
func TestOrigin(t *testing.T) {
	...
	entn := &entity.TestEntity{5, false, 0}
	ento := &entity.TestEntity{5, false, 0}
	lmn.AddEntity(entn)
	lmo.AddEntity(ento)
...
func TestDetection(t *testing.T) {
	...
	ent1 := &entity.TestEntity{5, false, 0}
	ent2 := &entity.TestEntity{5, false, 0}
...
func TestStorage(t *testing.T) {
	...
	ent3 := &entity.TestEntity{5, false, 0}
	cm.AddEntity(ent2)
	cm.AddEntity(ent3)
	StoreCheck(t, cm, 3, 3)
}
